    ...
    public class ManageResourcesAdapter
    {
        ...
        public ManageResourcesResponse AddResources(ManageResourcesRequest request)
        {
            ...
            using (var context = new Company_dbEntities())
            {
                ...
                Resources_table resp = new Resources_table();
        ...
        public ManageResourcesResponse UpdateResources(ManageResourcesRequest request)
        {
            ...
            using (var context = new Company_dbEntities())
            {
                ...
                var comp = (from a in context.Resources_table where a.CompanyName == request.CompanyName && a.NameOfDevice == request.NameOfDevice  select a).FirstOrDefault<Resources_table>();
        ...
        public ManageResourcesResponse DeleteResources(ManageResourcesRequest request)
        {
            ...
            using (var context = new Company_dbEntities())
            {
                ...
                resource = (from a in context.Resources_table where request.CompanyName == a.CompanyName && request.NameOfDevice == a.NameOfDevice && request.Type == a.Type && request.EmployeeID == a.EmployeeID select a).FirstOrDefault<Resources_table>();
